...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:	  
      playAdventurer(currentPlayer, state);  //separate function per assignment 2
	return 0;		
    case council_room:
      //+4 Cards
      for (i = 0; i < 4; i++)
    ...
    case smithy:
      playSmithy(currentPlayer, state, handPos);  //separate function per assignment 2
    ...
    case steward:           
      playSteward(currentPlayer, state, choice1, choice2, choice3, handPos);  //separate function per assignment 2 		  
    ...
    case embargo: 
      playEmbargo(currentPlayer, state, choice1, handPos);  //separate function per assignment 2
    ...
    case sea_hag:
      playSeaHag(currentPlayer, state);  //separate function per assignment 2 
