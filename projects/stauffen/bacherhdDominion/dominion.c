...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return caAdventurer(state, currentPlayer);
    ...
    case smithy:
      return caSmithy(state, currentPlayer, handPos);
    ...
    case great_hall:
      return caGreatHall(state, currentPlayer, handPos);
    ...
    case cutpurse:
      return caCutpurse(state, currentPlayer, handPos);
    ...
    case sea_hag:
      return caSeaHag(state, currentPlayer);
